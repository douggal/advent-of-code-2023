...
@main
def Main(day: Int = 26, runType: Int = 1): Unit = {
    ...
    val d14 = Day14(s"$title Day $day", runType)
    val d15 = Day15(s"$title Day $day", runType)
    val d25 = Day25(s"$title Day $day", runType)
    val d25_v2 = Day25_v2(s"$title Day $day", runType)
